...
$functions = array(
    ...
    'tiny_recitautolink_get_cm_list' => array(
        'classname'   => 'tiny_recitautolink_external',
        'methodname'  => 'get_cm_list',
        'classpath'   => '/lib/editor/tiny/plugins/recitautolink/externallib.php',
        'description' => 'Returns cm list',
        'type'        => 'read',
        'ajax'        => true,
),
'tiny_recitautolink_get_section_list' => array(
        'classname'   => 'tiny_recitautolink_external',
...
'tiny_recitautolink_get_h5p_list' => array(
        'classname'   => 'tiny_recitautolink_external',
...
'tiny_recitautolink_get_role_list' => array(
        'classname'   => 'tiny_recitautolink_external',
