        ...
        <Form>
            ...
            <Form.Group controlId={"itemactivity3"}>
                <div className="d-flex align-items-center">
                    <Form.Check  className="m-1" id={`opening1`} inline type='radio' label={M.util.get_string('sametab', 'tiny_recitautolink')} name='opening' onChange={this.onChange} value='sametab'/>
                </div>
                <div className="d-flex align-items-center">
                    <Form.Check  className="m-1" id={`opening2`} inline type='radio' label={M.util.get_string('newtab', 'tiny_recitautolink')} name='opening' onChange={this.onChange} value='newtab'/>
                </div>
                <div className="d-flex align-items-center">
                    <Form.Check  className="m-1" id={`opening3`} inline type='radio' label={M.util.get_string('modal', 'tiny_recitautolink')} name='opening' onChange={this.onChange} value='modal'/>
                </div>
                <div className="d-flex align-items-center">
                    <Form.Check  className="m-1" id={`opening4`} inline type='radio' label={M.util.get_string('modal16x9', 'tiny_recitautolink')} name='opening' onChange={this.onChange} value='modal16x9'/>
                </div>
            </Form.Group>
            <Form.Group ><hr/></Form.Group>
            <Form.Group controlId={"itemactivity4"}>
                <div className="d-flex align-items-center">
                    <Form.Check className="m-1" id='otheroptions1' inline type='checkbox' label={M.util.get_string('icon', 'tiny_recitautolink')} name='otheroptions' onChange={this.onChange} value='icon'/>
                </div>
                <div className="d-flex align-items-center">
                    <Form.Check className="m-1" id='otheroptions2' inline type='checkbox' label={M.util.get_string('completioncheckbox', 'tiny_recitautolink')} name='otheroptions' onChange={this.onChange} value='completion'/>
                </div>
            </Form.Group>  
            ...
            <Form.Group controlId={"itemactivity5"}>
                <div className='d-flex align-items-center'>
                    <Form.Check className="m-1" id='activitybtn' inline type='checkbox' label={M.util.get_string('button', 'tiny_recitautolink')} name='activitybtn' onChange={this.onChange} value='btn btn-primary'/>
                    <HelpButton helpText={<>
